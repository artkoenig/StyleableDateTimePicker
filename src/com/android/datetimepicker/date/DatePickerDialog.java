...
public class DatePickerDialog extends DialogFragment implements
    ...
    public static final String STYLE_ARG = "DateTimePickerStyle";
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                               ...
                                               int dayOfMonth,
                                               int styleId) {
        DatePickerDialog ret = newInstance(callBack, year, monthOfYear, dayOfMonth);
        Bundle args = new Bundle();
        args.putInt(STYLE_ARG, styleId);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = localInflater.inflate(R.layout.date_picker_dialog, null);
