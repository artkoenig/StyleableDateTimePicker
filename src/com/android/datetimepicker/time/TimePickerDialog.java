...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback,
                                               int hourOfDay, int minute, boolean is24HourMode, int styleId) {
        TimePickerDialog ret = newInstance(callback, hourOfDay, minute, is24HourMode);
        Bundle args = new Bundle();
        args.putInt(DatePickerDialog.STYLE_ARG, styleId);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Context context = new ContextThemeWrapper(getActivity(), styleId);
        LayoutInflater localInflater = inflater.cloneInContext(context);
        View view = localInflater.inflate(R.layout.time_picker_dialog, null);
        ...
        mDoneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				...
				// save state for reusing on back stack changes
				mInitialHourOfDay = mTimePicker.getHours();
				mInitialMinute = mTimePicker.getMinutes();
